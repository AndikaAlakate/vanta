    ...
    <div id="carouselExampleCaptions" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="./pic/background/Background-1.png" class="d-block w-100" alt="...">
            ...
            <div class="row">
                <div class="col-sm-4 mb-3">
                    <div class="card shadow">
                        <div class="card-img">
                            <img src="e-book/e-book-7.jpg" alt="Buku 1" class="img-fluid card-img-top">
                        </div>
                        <div class="card-body">
                            <h4 class="card-text">Judul Buku 1</h4>
                            <!-- <hr> -->
                            <p class="card-text">Penulis: Penulis 1</p>
                            <p class="card-text">Tahun Terbit: 2023</p>
                            <a href="detail-buku-1.html" class="btn btn-primary btn-sm">Detail Buku</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 mb-3">
                ...
                <div class="col-sm-4 mb-3">
                    <div class="card shadow">
                        <div class="card-img">
                            <img src="e-book/e-book-9.jpeg" alt="Buku 1" class="img-fluid card-img-top">
                        </div>
                        <div class="card-body">
                            <h4>Judul Buku 1</h4>
                            <p>Penulis: Penulis 1</p>
                ...
                <div class="col-sm-4 mb-3">
                    <div class="card shadow">
                        <div class="card-img">
                            <img src="e-book/e-book-12.jpg" alt="Buku 1" class="img-fluid card-img-top">
                        </div>
                        <div class="card-body">
                            <h4>Judul Buku 1</h4>
                            <p>Penulis: Penulis 1</p>
        ...
        <div class="container">
            ...
            <div class="row mt-3">
                <div class="col-md-12 text-center">
                    <h5>Ikuti Kami</h5>
                    <p></p>
                    <a href="#" class="btn btn-primary mx-2">Facebook</a>
                    <a href="#" class="btn btn-primary mx-2">Instagram</a>
                    <a href="#" class="btn btn-primary mx-2">Twitter</a>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-md-12 text-center">
